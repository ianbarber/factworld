...
`scripts/experiment_dense_supervision.py`. gdp_hybrid d256x4, 4000 steps, seeds [0, 1, 2, 3, 5, 6, 7, 8, 9]. K = holder supervised every K events (K=1 dense). Guided free-run eval (events forced, holder/value slots generated). Floor = 0.20.

| K (stride) | value @L16 | value @L32 | value @L64 | value @L128 | conv(>0.5) @L16 |
|---|---|---|---|---|---|
| 1 | 1.00±0.00 | 0.90±0.12 | 0.74±0.24 | 0.64±0.30 | 9/9 |
