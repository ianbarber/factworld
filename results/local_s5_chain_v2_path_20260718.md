# Local sweep — ['s5_chain_local_v2_path'] 

d_model=320 n_layers=4 steps=8000 seeds=[0, 1, 2] train_n=8000 eval_n=200

## s5_chain_local_v2_path  (eval lengths 4, 8)
| arch | L4 mean±std (pconv) | L8 mean±std (pconv) | holder/value @L4 |
|---|---|---|---|
| fprm | 0.15±0.01 (0%) | 0.12±0.02 (0%) | 0.15 / 0.00 |
| gdp_hybrid | 0.15±0.02 (0%) | 0.13±0.01 (0%) | 0.15 / 0.00 |
| transformer | 0.15±0.02 (0%) | 0.11±0.02 (0%) | 0.15 / 0.00 |
