...
`scripts/experiment_dense_supervision.py`. fprm d256x4, 4000 steps, seeds [0, 1, 2, 3, 4]. K = holder supervised every K events (K=1 dense). Guided free-run eval (events forced, holder/value slots generated). Floor = 0.20.

| K (stride) | value @L16 | value @L64 | conv(>0.5) @L16 |
|---|---|---|---|
| 1 | 1.00±0.00 | 0.19±0.04 | 5/5 |
| 8 | 0.20±0.05 | 0.17±0.02 | 0/5 |
