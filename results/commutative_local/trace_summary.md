...
d_model=256 n_layers=4 steps=8000 batch=32 train_n=8000 eval_n=200 seeds=[0] train_lengths=[4, 8, 16] use_trace=True

| arch | L16 mean±std (pconv) | L32 mean±std (pconv) | L64 mean±std (pconv) |
|---|---|---|---|
| gdp_hybrid | 0.22±0.00 (0%) | 0.17±0.00 (0%) | 0.20±0.00 (0%) |
