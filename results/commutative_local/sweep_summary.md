...
d_model=256 n_layers=4 steps=8000 batch=32 train_n=8000 eval_n=200 seeds=[0, 1, 2] train_lengths=[4, 8, 16] use_trace=False

| arch | L16 mean±std (pconv) | L32 mean±std (pconv) | L64 mean±std (pconv) |
|---|---|---|---|
| fprm | 0.17±0.00 (0%) | 0.18±0.02 (0%) | 0.20±0.01 (0%) |
| gdp_hybrid | 0.21±0.02 (0%) | 0.19±0.02 (0%) | 0.21±0.02 (0%) |
| transformer | 0.16±0.01 (0%) | 0.20±0.01 (0%) | 0.20±0.02 (0%) |
