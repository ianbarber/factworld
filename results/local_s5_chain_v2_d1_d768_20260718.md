...
d_model=768 n_layers=8 steps=8000 seeds=[0, 1, 2] train_n=8000 eval_n=200

## s5_chain_local_v2  (eval lengths 4, 8)
| arch | L4 mean±std (pconv) | L8 mean±std (pconv) | holder/value @L4 |
|---|---|---|---|
| fprm | 0.15±0.02 (0%) | 0.12±0.02 (0%) | 0.15 / 0.00 |
| gdp_hybrid | 0.13±0.02 (0%) | 0.16±0.01 (0%) | 0.13 / 0.00 |
