...
Same setup as rl_grpo (d256, answer-only SFT warmup then GRPO, outcome 0/1 reward, free scratchpad).
  ...
  .venv/bin/python followups/parametric-recall/rl_flicker.py
"""
import os
import statistics
import sys
...
def write_md(agg):
    lines = [
        ...
        "`followups/parametric-recall/rl_flicker.py`. gdp_hybrid d256, answer-only SFT warmup then GRPO 7500 "
