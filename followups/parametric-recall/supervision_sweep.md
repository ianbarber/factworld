...
`followups/parametric-recall/supervision_sweep.py`. gdp_hybrid d256x4, 4000 steps, 5 seeds, parametric recall. Holder supervised every K events (+ always the final). K=1 == dense capstone; K=inf == answer-only (only the final holder, the R3b floor). Train lengths (4,8,16) so a 16-event episode gets 16/8/4/2/1 checkpoints at K=1/2/4/8/inf. Metric: end-to-end free-running composite (`e2e_v`); `dense_h` = teacher-forced acc at labelled slots. Floor = 0.20.
