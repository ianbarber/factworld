...
gdp_hybrid d384 (18.5M), 3 seeds. Compare directly to supervision_sweep.md (same build, train ≤16).
  ...
  .venv/bin/python followups/parametric-recall/sup_horizon.py
"""
import math
import os
import random
...
def write_md(agg):
    lines = [
        ...
        "`followups/parametric-recall/sup_horizon.py`. gdp_hybrid d384 (18.5M), 3 seeds. Density sweep K with "
