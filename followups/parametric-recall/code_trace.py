...
of the abstract role-permutation rendering — bridging "S5 word problem" to "tracking program state."
  ...
  .venv/bin/python followups/parametric-recall/code_trace.py
"""
import math
import os
import random
...
def write_md(agg):
    lines = [
        ...
        "`followups/parametric-recall/code_trace.py`. gdp_hybrid d384 (18.5M), 3 seeds. Our non-abelian dynamics "
