...
We also log the holder-resolution rate (state leg) to see whether RL learns the state even without rewarding it.
  ...
  .venv/bin/python followups/parametric-recall/rl_grpo.py
"""
import os
import random
import statistics
...
def write_md(agg):
    lines = [
        ...
        "`followups/parametric-recall/rl_grpo.py`. gdp_hybrid d256x4, 3 seeds. Within-seed contrast: answer-only "
