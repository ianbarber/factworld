...
trained step-count, and you extend reach by training longer — confirming the §6 lesson mechanistically.
  ...
  .venv/bin/python followups/parametric-recall/horizon_mech.py
"""
import math
import os
import random
...
def write_md(agg):
    lines = [
        ...
        "`followups/parametric-recall/horizon_mech.py`. gdp_hybrid d384 (18.5M), mixed density, 3 seeds. Train "
