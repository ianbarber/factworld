...
| **Post-training deep-state coverage DOES extend it — on a clean base** — floor→0.99 at 4×, **0.86 at 8×**, label-free (§6.1) | `post_state.py` | base floors past L32; post **on a clean base** L64 0.99 / L128 0.86; **3-seed mean 0.47/0.44** (high-variance — only the clean-base seed lifts) |
