...
`followups/non-abelian-state/ladder.py`. gdp_hybrid, d256x4 (~6M), 4000 steps, 3 seeds. Parametric recall = fixed agent->a0 map, facts NOT in prompt. Floor = 1/k = 0.20. CoT rungs (R2/R3b) use strict eval (holder AND value); no-CoT rungs (R0/R1/R3a) score the emitted value only.
